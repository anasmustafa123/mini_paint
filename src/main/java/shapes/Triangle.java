...
public class Triangle extends AbstractShape{
    ...
    public JsonObject toJsonJSObject() {
        ...
        temp.put("x3",getPosition3().x);
        temp.put("y3",getPosition3().y);
    ...
    public Shape fromJsonToShape(JsonObject object) {
        ...
        triangle.setColor((Color) object.get("borderColor"));
        triangle.setFillColor((Color) object.get("fillColor"));
        triangle.setPosition(new Point( ((BigDecimal)object.get("x1") ).intValue() , ( (BigDecimal)object.get("y1") ).intValue() ));
        triangle.setPosition2(new Point( ((BigDecimal)object.get("x2") ).intValue() , ( (BigDecimal)object.get("y2") ).intValue() ));
        triangle.setPosition3(new Point( ((BigDecimal)object.get("x3") ).intValue() , ( (BigDecimal)object.get("y3") ).intValue() ));
        return triangle;
    }
}
